...
def mutate_genome_with_hox(genome):
    ...
    """
    if genome is None:
        # Handle the case where genome is None. This might involve logging an error,
        # raising an exception, or using a default genome structure.
        print("Error: Attempted to mutate a None genome.")
...
##################
# %%
def mutate_genome_without_hox(genome):
    """
    ...
    # Mutate the genome without HOX operations
    # Different mutation probabilities can be set here
